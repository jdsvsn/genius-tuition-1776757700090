...
const basePath = '/genius-tuition-1776757700090';
...
export default function Home() {
  ...
  const products = [{ n: '1', d: 'Our personalized tutoring programs are tailored to meet the specific needs of each student, providing one-on-one attention and guidance to help them achieve academic success. Our experienced instructors work closely with students to identify areas of strength and weakness, developing customized learning plans that cater to their unique learning style.', i: 'https://images.pexels.com/photos/5212655/pexels-photo-5212655.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: '2', d: 'Our small group classes offer a collaborative and interactive learning environment, where students can engage with their peers, share ideas, and develop essential social skills. With a focus on teamwork and communication, our group classes promote a sense of community and camaraderie, while maintaining high academic standards.', i: 'https://images.pexels.com/photos/6344241/pexels-photo-6344241.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: '3', d: 'Our intensive revision courses are designed to help students prepare for exams, providing targeted support and guidance to ensure they feel confident and prepared. With a focus on key subjects and topics, our revision courses offer a comprehensive review of the curriculum, highlighting essential concepts and techniques.', i: 'https://images.pexels.com/photos/6502728/pexels-photo-6502728.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: '4', d: 'Our holiday programs offer a fun and engaging way for students to stay learning during school breaks, with a range of interactive activities, workshops, and projects that promote creativity, critical thinking, and problem-solving. From STEM experiments to art classes, our holiday programs provide a unique opportunity for students to explore new interests and hobbies.', i: 'https://images.pexels.com/photos/7172856/pexels-photo-7172856.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: '5', d: 'Our educational consulting services provide expert guidance and support to help students and parents navigate the education system, from selecting the right school to choosing the best career path. With a deep understanding of the local education landscape, our experienced consultants offer personalized advice and recommendations, tailored to the individual needs and goals of each student.', i: 'https://images.pexels.com/photos/5905475/pexels-photo-5905475.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                Genius Tuition is a premier education center in Kuching, dedicated to providing high-quality academic support to students of all ages. With a strong emphasis on mental health and well-being, our experienced instructors create a nurturing environment that fosters academic excellence and personal growth. By combining innovative teaching methods with a passion for learning, we empower students to reach their full potential.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become the leading tuition center in Kuching, renowned for our commitment to excellence, mental health, and student success.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To provide personalized, high-quality educational services that cater to the unique needs of each student, while promoting mental well-being and a love of learning.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mental Health</h4>
                  <p className="text-sm text-on-surface-variant">At Genius Tuition, we prioritize mental health by creating a supportive and inclusive environment that encourages students to express themselves, manage stress, and develop healthy coping mechanisms.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Quality</h4>
                  <p className="text-sm text-on-surface-variant">We are dedicated to delivering exceptional quality in all aspects of our services, from curriculum design to instructor training, to ensure that our students receive the best possible education and support.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/36834054/pexels-photo-36834054.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/9489774/pexels-photo-9489774.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/8926900/pexels-photo-8926900.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
